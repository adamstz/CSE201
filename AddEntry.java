...
//Adds New Video Game to VideoGameList.txt by prompting information from User
public class AddEntry {
	/**
	 * Creates Add Entry button
	 * 
	 * @param jf    frame everything runs on
	 * @param panel north panel that holds all buttons
	 */
				...
				class jbuttonclicked implements ActionListener {
					...
					public void actionPerformed(ActionEvent e) {
						...
						if (e.getSource().equals(enterButton)) {
							try {
								addToTextFile(nameText.getText(), descText.getText(), platsText.getText(),
										devText.getText(), priceText.getText());
								refresh(jf);
								userInput.dispose();
	...
	/**
	 * Adds Video Game Entry to Text file
	 * 
	 * @param name
	 * @param description
	 * @param platforms
	 ...
	 * @throws IOException
	 */
	public static void addToTextFile(String name, String description, String platforms, String developer, String price)
			throws IOException {
		FileWriter fw = null;
